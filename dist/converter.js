...
function _convert() {
  ...
  /*#__PURE__*/
  regeneratorRuntime.mark(function _callee(inputPath, option) {
      ...
      while (1) {
        switch (_context.prev = _context.next) {
          case 0:
            ...
            throw new Error("Make sure the source file exist. ".concat(inputPath));

          case 2:
            if (!((0, _lodash.isObject)(option) && (option.output || option.buffer))) {
              _context.next = 16;
              break;
            }
